  ...
  export default function FAQ() {
    return (
      <div className="bg-white">
        <div className="mx-auto max-w-6xl py-12 sm:py-20 " data-aos='zoom-y-out' data-aos-delay='300'>
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Frequently asked questions</h2>
          </div>
          <div className="md:mt-20 sm:mt-16 mt-10">
            <dl className="space-y-10 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:gap-y-10 lg:space-y-0 lg:max-w-full lg:text-left text-center max-w-md mx-auto">
              {faqs.map((faq) => (
                <div key={faq.id}>
