            ...
            <div className="bg-white">
                <div className="mx-auto max-w-6xl xl:pt-40 lg:pt-36 sm:pt-32 pt-24 px-4 sm:px-6 lg:px-8">
                    <div className="sm:align-center sm:flex sm:flex-col">
                        <h1 className="sm:text-5xl text-4xl font-bold tracking-tight text-gray-900 text-center leading-snug" data-aos='zoom-y-in'
                            data-aos-delay='150'>Simple, transparent pricing</h1>
                        <p className="mt-4 text-xl text-gray-600 text-center" data-aos='zoom-y-out'
                            data-aos-delay='300'>
                            Get the Open PRO plan that fits your needs at a special introductory price.
                        </p>
                        <div className="relative mt-6 flex self-center justify-center rounded-lg sm:bg-gray-100 p-0.5 sm:mt-12">
                            <div className="flex items-center sm:justify-center justify-between gap-4">
                                <span class=" text-gray-600 font-medium sm:text-base text-sm">Billed Monthly</span>
                                ...
                                <span class=" text-gray-600 font-medium sm:text-base text-sm">Billed Annually</span>
                            </div>
                        </div>
                    </div>
                    <div data-aos='zoom-y-out' data-aos-delay='500' className="mt-8 space-y-4 sm:mt-16 sm:grid sm:grid-cols-1 sm:gap-6 sm:space-y-0 lg:mx-auto lg:max-w-4xl max-w-sm mx-auto xl:mx-0 xl:max-w-none lg:grid-cols-3">
                        {tiers.map((tier) => (
                            <div key={tier.name} className="rounded border border-gray-200 shadow-sm h-full bg-white ">
                                <div className="px-6 pt-6 pb-8 flex h-full flex-col justify-between">
                                    <div className="divide-y divide-gray-200">
                                        <div className="pb-4 sm:text-left text-center">
                                        ...
                                        <div className="pt-4">
                                            <h3 className="text-base sm:text-left text-center font-medium text-gray-900">{tier.featureTitle}</h3>
                                            <ul role="list" className="mt-6 space-y-4">
                                                {tier.includedFeatures.map((feature) => (
                                                    <li key={feature} className="flex space-x-3 sm:justify-start justify-center">
                    ...
                    <div className="border-t border-b border-gray-200 lg:py-4 py-6 lg:mt-7 mt-9 flex lg:flex-row flex-col gap-4 items-center justify-between">
                        <p className="text-lg font-semibold text-gray-800 sm:text-left text-center">
